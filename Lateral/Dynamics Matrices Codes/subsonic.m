...
System1=ss(A1,B1,C1,D1,'statename',states,'inputname',inputs,'outputname',outputs)
T=tf(System1)
damp(A1)
%Graphs
figure()
rlocus(T(2,1))
title 'Roll Rate Feedback to Aileron'

figure()
rlocus(-T(3,2))
title 'Yaw Rate Feedback to Rudder'

figure()
rlocus(T(2,2))
title 'Roll Rate Feedback to Rudder'
